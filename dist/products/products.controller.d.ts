...
export declare class ProductsController {
    ...
    update(id: string, updateProductDto: CreateProductDto): import("mongoose").Query<import("mongoose").Document<unknown, {}, import("./schemas/product.schema").Product> & import("./schemas/product.schema").Product & {
        _id: import("mongoose").Types.ObjectId;
    }, import("mongoose").Document<unknown, {}, import("./schemas/product.schema").Product> & import("./schemas/product.schema").Product & {
        _id: import("mongoose").Types.ObjectId;
    }, {}, import("./schemas/product.schema").Product, "findOneAndUpdate", {}>;
